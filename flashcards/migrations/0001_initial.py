# Generated by Django 5.1.2 on 2024-10-26 23:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flashcard', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='actividad', to='flashcards.flashcard')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estudiante', models.ForeignKey(limit_choices_to={'rol': 'estudiante'}, on_delete=django.db.models.deletion.CASCADE, related_name='padre', to='flashcards.user')),
                ('padre', models.ForeignKey(limit_choices_to={'rol': 'padre'}, on_delete=django.db.models.deletion.CASCADE, related_name='hijos', to='flashcards.user')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estudiante', models.ForeignKey(limit_choices_to={'rol': 'estudiante'}, on_delete=django.db.models.deletion.CASCADE, related_name='progreso', to='flashcards.user')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estudiante', models.ForeignKey(limit_choices_to={'rol': 'estudiante'}, on_delete=django.db.models.deletion.CASCADE, related_name='estudiante_actividad', to='flashcards.user')),
            ],
        ),
    ]
